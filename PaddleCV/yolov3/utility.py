...
def parse_args():
    ...
    add_arg('data_dir',         str,    'dataset/insect',        "The data root path.")
    ...
    add_arg('max_iter',         int,    70200, "Iter number.")
    ...
    add_arg('no_mixup_iter',    int,    70200,  "Disable mixup in last N iter.")
    # TRAIN TEST INFER
